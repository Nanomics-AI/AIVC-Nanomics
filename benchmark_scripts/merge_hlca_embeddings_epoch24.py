...
EMB0 = os.path.join(DIR, "epoch24_all18_part0_embeddings.npy")
EMB1 = os.path.join(DIR, "epoch24_all18_part1_embeddings.npy")

ROWS0 = os.path.join(DIR, "epoch24_all18_part0_rows.csv")
ROWS1 = os.path.join(DIR, "epoch24_all18_part1_rows.csv")
...
OUT_EMB = os.path.join(DIR, "epoch24_all18_embeddings.npy")
OUT_ROWS = os.path.join(DIR, "epoch24_all18_rows.csv")


print("=" * 72)
print("MERGE EPOCH24 HLCA EMBEDDINGS")
print("=" * 72)
